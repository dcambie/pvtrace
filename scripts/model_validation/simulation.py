...
trace = Tracer(scene=scene, source=reactor.source, seed=None, throws=100000, database_file=None, use_visualiser=False, show_log=False, show_axis=True, show_counter=True)
