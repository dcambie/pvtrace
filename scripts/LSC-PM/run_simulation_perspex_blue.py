...
file_path = os.path.join('D:/','LSC_PM_simulation_results', '10x10x0.3_Perspex_blue', 'simulation_results_overwrite.txt')

# scene = pvtrace.Scene(level=logging.INFO, uuid="Fang_rebuttal2_6")
scene = pvtrace.Scene(level=logging.INFO, uuid='10x10x0.3_Perspex_blue')
