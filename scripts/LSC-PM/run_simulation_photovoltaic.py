...
file_path = os.path.join('D:/','LSC_PM_simulation_results', 'photovoltaic', 'PV_redLSC_PM', 'simulation_results.txt')

# scene = pvtrace.Scene(level=logging.INFO, uuid="Fang_rebuttal2_6")
scene = pvtrace.Scene(level=logging.INFO, uuid='0312final_try')
...
reactor = Reactor(reactor_name="10x10_chong_thickness0.3cm", luminophore=Lm_lr305, matrix=pmma, photocatalyst="MB",
                  photocatalyst_concentration=0.0012, solvent='ACN', exist_photovoltaic_bottom=True, exist_photovoltaic_edge=True)
