...
reactor = Reactor(reactor_name="5x5_square", dye="Red305", dye_concentration=0.20, photocatalyst="MB",
...
trace = pvtrace.Tracer(scene=scene, source=reactor.source, seed=None, throws=0, use_visualiser=True,
