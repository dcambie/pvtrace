...
scene = pvtrace.Scene(level=logging.INFO, uuid="1sqm_2dir_2.5cm")
...
reactor = Reactor(reactor_name="1sqm_2dir_2.5cm", luminophore=lr305, matrix=pdms, photocatalyst="MB",
