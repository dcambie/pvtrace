...
file_path = os.path.join('C:/','LSC_PM_simulation_results', 'Green_PMMA_10x10x0.4_1M_Blank', 'simulation_results.txt')

# scene = pvtrace.Scene(level=logging.INFO, uuid="Fang_rebuttal2_6")
scene = pvtrace.Scene(level=logging.INFO, uuid='Green_PMMA_10x10x0.4_1M_Blank')
