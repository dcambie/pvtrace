...
config.set('Main', 'name', 'Reactor (Fang bifurcation+chamber, 8 channels, '+str(spacing)+' mm spacing)')
...
geometry.append(((x_start, 168.7, 1), (1.05, 16.35, 1)))  # Outlet
...
with open('Fang_8ch_chamber_'+str(spacing)+'mm.ini', 'wb') as configfile:
