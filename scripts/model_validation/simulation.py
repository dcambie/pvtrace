...
for mainloop_i in range(0, 31):
    concentration = 0.01+mainloop_i*0.01
    ...
    reactor = Reactor(reactor_name="5x5_6ch_squared", dye="Red305", dye_concentration=concentration, photocatalyst="Air",
                      photocatalyst_concentration=0.0004)
