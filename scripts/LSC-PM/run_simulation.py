...
scene = pvtrace.Scene(level=logging.INFO, uuid='Fang_2ch_blueLED_9V_10k')
...
reactor = Reactor(reactor_name="5x5_fang_2ch", luminophore=lr305, matrix=pdms, photocatalyst="MB",
                  photocatalyst_concentration=0.0004)
scene.add_objects(reactor.scene_obj)

lamp = LightSource(lamp_type='Blue LEDs')
